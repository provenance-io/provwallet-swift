...
public struct Ibc_Applications_Fee_V1_Fee {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// the packet receive fee
  public var recvFee: [Cosmos_Base_V1beta1_Coin] = []

  /// the packet acknowledgement fee
  public var ackFee: [Cosmos_Base_V1beta1_Coin] = []

  /// the packet timeout fee
  public var timeoutFee: [Cosmos_Base_V1beta1_Coin] = []
...
public struct Ibc_Applications_Fee_V1_PacketFee {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var refundAddress: String = String()
...
public struct Ibc_Applications_Fee_V1_PacketFees {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// list of packet fees
  public var packetFees: [Ibc_Applications_Fee_V1_PacketFee] = []
...
public struct Ibc_Applications_Fee_V1_IdentifiedPacketFees {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Applications_Fee_V1_Fee: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Ibc_Applications_Fee_V1_Fee, rhs: Ibc_Applications_Fee_V1_Fee) -> Bool {
...
extension Ibc_Applications_Fee_V1_PacketFee: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PacketFee"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "fee"),
  ...
  public static func ==(lhs: Ibc_Applications_Fee_V1_PacketFee, rhs: Ibc_Applications_Fee_V1_PacketFee) -> Bool {
...
extension Ibc_Applications_Fee_V1_PacketFees: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PacketFees"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Ibc_Applications_Fee_V1_PacketFees, rhs: Ibc_Applications_Fee_V1_PacketFees) -> Bool {
...
extension Ibc_Applications_Fee_V1_IdentifiedPacketFees: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".IdentifiedPacketFees"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Ibc_Applications_Fee_V1_IdentifiedPacketFees, rhs: Ibc_Applications_Fee_V1_IdentifiedPacketFees) -> Bool {
