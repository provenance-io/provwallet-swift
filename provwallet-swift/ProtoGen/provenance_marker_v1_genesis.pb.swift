...
public struct Provenance_Marker_V1_GenesisState {
  ...
  public var markers: [Provenance_Marker_V1_MarkerAccount] = []
...
extension Provenance_Marker_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Provenance_Marker_V1_GenesisState, rhs: Provenance_Marker_V1_GenesisState) -> Bool {
