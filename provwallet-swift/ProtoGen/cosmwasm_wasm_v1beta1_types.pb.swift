...
public enum Cosmwasm_Wasm_V1beta1_AccessType: SwiftProtobuf.Enum {
...
extension Cosmwasm_Wasm_V1beta1_AccessType: CaseIterable {
  ...
  public static var allCases: [Cosmwasm_Wasm_V1beta1_AccessType] = [
    .unspecified,
    .nobody,
    .onlyAddress,
    .everybody,
...
public enum Cosmwasm_Wasm_V1beta1_ContractCodeHistoryOperationType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Cosmwasm_Wasm_V1beta1_ContractCodeHistoryOperationType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Cosmwasm_Wasm_V1beta1_ContractCodeHistoryOperationType] = [
    .unspecified,
    .init_,
    .migrate,
    .genesis,
...
/// AccessTypeParam
public struct Cosmwasm_Wasm_V1beta1_AccessTypeParam {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var value: Cosmwasm_Wasm_V1beta1_AccessType = .unspecified
...
public struct Cosmwasm_Wasm_V1beta1_AccessConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var permission: Cosmwasm_Wasm_V1beta1_AccessType = .unspecified
...
public struct Cosmwasm_Wasm_V1beta1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var codeUploadAccess: Cosmwasm_Wasm_V1beta1_AccessConfig {
  ...
  public var hasCodeUploadAccess: Bool {return self._codeUploadAccess != nil}
  ...
  public var instantiateDefaultPermission: Cosmwasm_Wasm_V1beta1_AccessType = .unspecified
...
public struct Cosmwasm_Wasm_V1beta1_CodeInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var instantiateConfig: Cosmwasm_Wasm_V1beta1_AccessConfig {
  ...
  public var hasInstantiateConfig: Bool {return self._instantiateConfig != nil}
  /// Clears the value of `instantiateConfig`. Subsequent reads from it will return its default value.
  public mutating func clearInstantiateConfig() {self._instantiateConfig = nil}
...
public struct Cosmwasm_Wasm_V1beta1_ContractInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// use for sorting
  public var created: Cosmwasm_Wasm_V1beta1_AbsoluteTxPosition {
  ...
  public var ibcPortID: String = String()

  /// Extension is an extension point to store custom metadata within the
  /// persistence model.
  public var `extension`: SwiftProtobuf.Google_Protobuf_Any {
...
public struct Cosmwasm_Wasm_V1beta1_ContractCodeHistoryEntry {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var operation: Cosmwasm_Wasm_V1beta1_ContractCodeHistoryOperationType = .unspecified

  /// CodeID is the reference to the stored WASM code
  public var codeID: UInt64 = 0

  /// Updated Tx position when the operation was executed.
  public var updated: Cosmwasm_Wasm_V1beta1_AbsoluteTxPosition {
...
public struct Cosmwasm_Wasm_V1beta1_AbsoluteTxPosition {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmwasm_Wasm_V1beta1_Model {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmwasm_Wasm_V1beta1_AccessTypeParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessTypeParam"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ]
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_AccessTypeParam, rhs: Cosmwasm_Wasm_V1beta1_AccessTypeParam) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_AccessConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AccessConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_AccessConfig, rhs: Cosmwasm_Wasm_V1beta1_AccessConfig) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_Params, rhs: Cosmwasm_Wasm_V1beta1_Params) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_CodeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_CodeInfo, rhs: Cosmwasm_Wasm_V1beta1_CodeInfo) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_ContractInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_ContractInfo, rhs: Cosmwasm_Wasm_V1beta1_ContractInfo) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_ContractCodeHistoryEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ContractCodeHistoryEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_ContractCodeHistoryEntry, rhs: Cosmwasm_Wasm_V1beta1_ContractCodeHistoryEntry) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_AbsoluteTxPosition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AbsoluteTxPosition"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_AbsoluteTxPosition, rhs: Cosmwasm_Wasm_V1beta1_AbsoluteTxPosition) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Model: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_Model, rhs: Cosmwasm_Wasm_V1beta1_Model) -> Bool {
