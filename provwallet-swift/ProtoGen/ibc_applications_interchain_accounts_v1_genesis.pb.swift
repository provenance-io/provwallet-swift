...
public struct Ibc_Applications_InterchainAccounts_V1_GenesisState {
  ...
  fileprivate var _controllerGenesisState: Ibc_Applications_InterchainAccounts_V1_ControllerGenesisState? = nil
  fileprivate var _hostGenesisState: Ibc_Applications_InterchainAccounts_V1_HostGenesisState? = nil
}
...
extension Ibc_Applications_InterchainAccounts_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._controllerGenesisState {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    if let v = self._hostGenesisState {
