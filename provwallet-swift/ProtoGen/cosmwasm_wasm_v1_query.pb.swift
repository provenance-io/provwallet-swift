...
/// RPC method
public struct Cosmwasm_Wasm_V1_QueryPinnedCodesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmwasm_Wasm_V1_QueryPinnedCodesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmwasm_Wasm_V1_QueryPinnedCodesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryPinnedCodesRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    2: .same(proto: "pagination"),
  ]
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1_QueryPinnedCodesRequest, rhs: Cosmwasm_Wasm_V1_QueryPinnedCodesRequest) -> Bool {
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Cosmwasm_Wasm_V1_QueryPinnedCodesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryPinnedCodesResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
