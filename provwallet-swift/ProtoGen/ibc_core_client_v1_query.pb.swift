...
/// RPC method.
public struct Ibc_Core_Client_V1_QueryConsensusStateHeightsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Ibc_Core_Client_V1_QueryConsensusStateHeightsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// consensus state heights
  public var consensusStateHeights: [Ibc_Core_Client_V1_Height] = []
...
extension Ibc_Core_Client_V1_QueryConsensusStateHeightsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryConsensusStateHeightsRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "client_id"),
    2: .same(proto: "pagination"),
  ]
  ...
  public static func ==(lhs: Ibc_Core_Client_V1_QueryConsensusStateHeightsRequest, rhs: Ibc_Core_Client_V1_QueryConsensusStateHeightsRequest) -> Bool {
    if lhs.clientID != rhs.clientID {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Ibc_Core_Client_V1_QueryConsensusStateHeightsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryConsensusStateHeightsResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Ibc_Core_Client_V1_QueryConsensusStateHeightsResponse, rhs: Ibc_Core_Client_V1_QueryConsensusStateHeightsResponse) -> Bool {
