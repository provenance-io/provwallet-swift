...
public struct Cosmwasm_Wasm_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var params: Cosmwasm_Wasm_V1beta1_Params {
  ...
  public var codes: [Cosmwasm_Wasm_V1beta1_Code] = []

  public var contracts: [Cosmwasm_Wasm_V1beta1_Contract] = []

  public var sequences: [Cosmwasm_Wasm_V1beta1_Sequence] = []

  public var genMsgs: [Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  /// GenMsgs define the messages that can be executed during genesis phase in
  /// order. The intention is to have more human readable data that is auditable.
  public struct GenMsgs {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    /// sum is a single message
    public var sum: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs.OneOf_Sum? = nil

    public var storeCode: Cosmwasm_Wasm_V1beta1_MsgStoreCode {
      get {
    ...
    public var instantiateContract: Cosmwasm_Wasm_V1beta1_MsgInstantiateContract {
      get {
    ...
    public var executeContract: Cosmwasm_Wasm_V1beta1_MsgExecuteContract {
      get {
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs.OneOf_Sum, rhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs.OneOf_Sum) -> Bool {
...
public struct Cosmwasm_Wasm_V1beta1_Code {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var codeInfo: Cosmwasm_Wasm_V1beta1_CodeInfo {
...
public struct Cosmwasm_Wasm_V1beta1_Contract {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var contractState: [Cosmwasm_Wasm_V1beta1_Model] = []
...
public struct Cosmwasm_Wasm_V1beta1_Sequence {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var idKey: Data = Data()
...
extension Cosmwasm_Wasm_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_GenesisState, rhs: Cosmwasm_Wasm_V1beta1_GenesisState) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Cosmwasm_Wasm_V1beta1_GenesisState.protoMessageName + ".GenMsgs"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs, rhs: Cosmwasm_Wasm_V1beta1_GenesisState.GenMsgs) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Code: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_Code, rhs: Cosmwasm_Wasm_V1beta1_Code) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Contract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_Contract, rhs: Cosmwasm_Wasm_V1beta1_Contract) -> Bool {
...
extension Cosmwasm_Wasm_V1beta1_Sequence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmwasm_Wasm_V1beta1_Sequence, rhs: Cosmwasm_Wasm_V1beta1_Sequence) -> Bool {
